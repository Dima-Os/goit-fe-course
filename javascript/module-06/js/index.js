...
/*==========task-10=============*/
import { getSortedUniqueSkills } from './task-10.js';
const runTenthLog = () => {
  console.log(getSortedUniqueSkills(users));
};
const runTenthLogRef = document.querySelector('.run-tenth-log');
runTenthLogRef.addEventListener('click', runTenthLog);
